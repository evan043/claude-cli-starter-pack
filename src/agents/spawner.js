...
// ============================================================
// PROJECT L2 CONFIGS (Multi-Project Roadmaps)
// ============================================================

/**
 * L2 Agent types for project exploration
 */
const PROJECT_L2_AGENT_TYPES = {
  code_snippets: {
...
export { AGENT_CONFIGS, DOMAIN_KEYWORDS, PROJECT_L2_AGENT_TYPES };
...
export default {
  ...
  createCheckpoint,
  // Project L2 functions
  generateProjectL2Config,
  parseProjectL2Report,
  AGENT_CONFIGS,
  DOMAIN_KEYWORDS,
  PROJECT_L2_AGENT_TYPES,
};
