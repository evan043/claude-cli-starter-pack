/**
 * Account and API Requirement Detector
 *
 * Detects required accounts, API keys, and services based on
 * selected tools and MCP servers. Generates setup checklists.
 *
 * @module vision/analysis/account-detector
 */
